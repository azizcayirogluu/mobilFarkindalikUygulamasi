...
class _ProfilEkraniState extends State<ProfilEkrani> {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: isSelected ? AppColors.anaMavi : Colors.transparent, width: 3),
        ),
  ...
  Future<void> _cikisYap() async {
    bool? onay = await _onayDiyalogu(emoji: "👋", baslik: "Gidiyor musun?", icerik: "Kahramanlık görevine ara mı vermek istiyorsun? Seni özleyeceğiz!", butonMetni: "Evet, Dinleneceğim", renk: AppColors.anaMavi);
    if (onay == true) {
          ...
          SafeArea(
            child: Column(
              children: [
                ...
                Text(
                  isim.toUpperCase(),
                  style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w900, color: Color(0xFF1E293B), letterSpacing: 1.5),
                ),
                const SizedBox(height: 6),
                Container(
          ...
          Positioned(
            ...
            child: IconButton(
              icon: Container(
                ...
                child: const Icon(Icons.settings_rounded, color: Colors.blueGrey, size: 20),
              ),
  ...
  Widget _buildDangerZoneZone() {
    return Column(
      children: [
        ElevatedButton(
          onPressed: _cikisYap,
          style: ElevatedButton.styleFrom(backgroundColor: Colors.white, foregroundColor: Colors.blue, elevation: 0, minimumSize: const Size(200, 50), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15), side: BorderSide(color: Colors.blue.shade100))),
