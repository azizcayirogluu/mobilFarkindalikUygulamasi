...
class _DetectiveManagerState extends State<DetectiveManager> {
  ...
  void _formuSifirla() {
    setState(() {
      ...
      _secilenRenk = "#F44336";
      _editingDocId = null; // edit moddan çıkar
    });
  }
      ...
      try {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
                content: Text(_editingDocId != null ? "Soru güncellendi!" : "Soru eklendi!"),
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: _kaydet,
                            child: Text(
                                _editingDocId != null ? "GÜNCELLE" : "VERİTABANINA EKLE",
    ...
    return Column(
      ...
      children: [
        ...
        DropdownButtonFormField<String>(
          ...
          // Icon + isim birlikte gösterilir
          items: _ikonlar.map((e) => DropdownMenuItem(
            value: e['name'] as String,
            child: Row(
                children: [
                  Icon(e['icon'] as IconData, size: 20),
  ...
  Widget _buildQuestionsList() {
    return StreamBuilder<QuerySnapshot>(
      // Firestore’dan soruları anlık çeker
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, i) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      // Sol ikon → güvenli / tehlikeli
                      leading: CircleAvatar(
                        backgroundColor: data['durum'] == "GÜVENLİ"
                            ? Colors.green[50]
                            : Colors.red[50],
                      ...
                      // Sağ aksiyonlar (edit + delete)
                      trailing: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          IconButton(
                              icon: const Icon(Icons.edit_outlined, color: Colors.blue),
                              onPressed: () => _duzenle(docs[i]) // düzenleme
                          ),
                          IconButton(
                              icon: const Icon(Icons.delete_outline, color: Colors.redAccent),
                              onPressed: () => docs[i].reference.delete() // silme
                          ),
                        ],
                      ),
                    ),
