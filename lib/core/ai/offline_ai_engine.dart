...
class OfflineAIEngine {
  ...
  Future<void> init() async {
    try {
      final jsonString = await rootBundle.loadString('assets/offline_ai_responses.json');
  ...
  Future<Map<String, String>> analyzeMistakes(List<String> mistakes) async {
    ...
    if (_rulesData == null || mistakes.isEmpty) {
      return {
        "durum": "RİSKLİ",
        "neden": "Şu an internete bağlı değiliz. Ancak siber dünyada güvende kalmak için lütfen tanımadığın kişilerle konuşma ve kişisel bilgilerini paylaşma."
      };
    }
